...
<head>
	...
	<style>
		...
		.container-slideshow {
			...
			/* background-color: rgba(84, 84, 84, 0.408); */
			margin: auto;
			padding: auto;
			border-radius: 20px;
		}
		.masthead {
			background-image: url("assets/img/5361112.webp");
			object-fit:fill;
		}
	</style>
</head>
...
<body id="page-top">
		...
		<div class="container px-5">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
					<li class="nav-item "><a class="navbar-brand fw-lighter" href="#">Add Image</a></li>
					<li class="nav-item "><a class="navbar-brand fw-lighter" href="developer/developer.html">Developer</a></li>
					<li class="nav-item "><a class="fw-lighter nav-link me-lg-3" href="#about-us">About Us</a></li>
				</ul>
				<button class="btn btn-success rounded-pill px-3 mb-2 mb-lg-0 mr-3">
					<span class="d-flex align-items-center">
						<span class=""> <?php echo $user_data['user_name']; ?>
						</span>
				</button>
				...
				<!-- <button class="loginbtn btn btn-primary rounded-pill ml-10 px-3 mb-2 mb-lg-0">
					<span class="d-flex align-items-center">
						...
						<span onclick="window.location.href='login.php';" class="small">Login</span>
					</span>
				</button> -->
				<button class="loginbtn btn btn-primary rounded-pill ml-10 px-3 mb-2 mb-lg-0">
					<span class="d-flex align-items-center">
						<i class="bi bi-person me-2"></i>
						<!-- <a href="logout.php" class="small">Çıkış</a> -->
						<span onclick="window.location.href='logout.php';" class="small">Logout</span>
					</span>
				</button>
			</div>
		</div>
	...
	<section class="iframe-gallery-section ">
		<div>
			<iframe class="iframe-gallery" src="importla/phpgallery.html" height="720px" width="98%" frameborder="0"></iframe>
